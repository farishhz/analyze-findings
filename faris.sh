...
echo "${BG_BLUE}${STYLE_BOLD}${FG_WHITE}  welcome to Alfarisi Azmir guide          ${FORMAT_RESET}"
echo "${BG_BLUE}${STYLE_BOLD}${FG_WHITE}════════════════════════════════════════════${FORMAT_RESET}"
echo
...
echo
echo "${COLOR_MAGENTA}${STYLE_BOLD}For more cloud security tutorials, follow to:${FORMAT_RESET}"
echo "${COLOR_BLUE}https://github.com/farishhzr${FORMAT_RESET}"
echo